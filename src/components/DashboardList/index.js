...
export const DashboardList = (props) => {
    ...
    const data = handleFilterDataOption()
    console.log("🚀 ~ file: index.js ~ line 15 ~ SaleCinemaList ~ data", data)
    return (
        <>
            ...
            {value === "movie" ? (<SaleMovie />) : (<SaleCinema ticket={ticket} />)}
        </>
    )
}